defmodule ArblargWeb.ChatLive.Components.NewChatModal do
  @moduledoc false
  ...
  def render(assigns) do
    ...
    <!-- Create Group Form -->
      <%= if @show_create_group do %>
        <.live_component
          module={ArblargWeb.ChatLive.Components.GroupForm}
          id="group-form"
    ...
    <!-- Create Channel Form -->
      <%= if @show_create_channel do %>
        <.live_component
          module={ArblargWeb.ChatLive.Components.ChannelForm}
          id="channel-form"
        />
      <% end %>
    ...
    <!-- Browse Channels -->
      <%= if @show_browse_channels do %>
        <.live_component
          module={ArblargWeb.ChatLive.Components.ChannelBrowser}
          id="channel-browser"
