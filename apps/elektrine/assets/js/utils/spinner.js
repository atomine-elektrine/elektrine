...
export function spinnerSvg({ size = 'md', className = '' } = {}) {
  ...
  return `
    <svg class="${classes}" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" aria-hidden="true" role="status" aria-label="Loading">
      <path fill="currentColor" d="${SPINNER_PATH}" />
    </svg>
  `
}
