defmodule Elektrine.Messaging.ArblargProfiles do
  ...
  @extension_definitions [
    %{
      ...
      stability: "stable",
      required: false,
      events: ["urn:arblarg:ext:bootstrap:1#server.upsert"],
    ...
    %{
      ...
      stability: "experimental",
      required: false,
      events: ["urn:arblarg:ext:permissions:1#overwrite.upsert"],
      fallback: "reject_unsupported_event_type",
      gate: "required_for_arblarg_community_1_0",
    ...
    %{
      ...
      stability: "experimental",
      required: false,
      events: ["urn:arblarg:ext:moderation:1#action.recorded"],
      fallback: "reject_unsupported_event_type",
      gate: "required_for_arblarg_community_1_0",
    ...
    %{
      ...
      stability: "experimental",
      required: false,
      events: ["urn:arblarg:ext:dm:1#message.create"],
      fallback: "reject_unsupported_event_type",
      gate: "optional",
      env_flag: nil,
      test_command: nil,
    ...
    %{
      ...
      required: false,
      events: [
        "urn:arblarg:ext:voice:1#dm.call.invite",
        "urn:arblarg:ext:voice:1#dm.call.accept",
        "urn:arblarg:ext:voice:1#dm.call.reject",
        "urn:arblarg:ext:voice:1#dm.call.end",
        "urn:arblarg:ext:voice:1#dm.call.signal"
      ],
      fallback: "reject_unsupported_event_type",
      gate: "optional",
      env_flag: nil,
