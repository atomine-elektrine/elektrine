defmodule Elektrine.Messaging.FederationAccountPresenceState do
  @moduledoc false
  use Ecto.Schema
  ...
  schema "messaging_federation_account_presence_states" do
  ...
  def changeset(state, attrs) do
    ...
    |> unique_constraint([:remote_actor_id],
