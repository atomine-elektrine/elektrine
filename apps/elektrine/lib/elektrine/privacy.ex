  ...
  def privacy_error_message(error_type) do
    case error_type do
      ...
      :insufficient_dm_credits ->
        "You need 1 Atomine Credit to message someone new. Earn credits from Account > Proofs by running daily browser work or verifying a domain, web page, or social/profile proof"
