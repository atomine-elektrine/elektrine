defmodule Mix.Tasks.Elektrine.MigrateEmailAttachments do
  @moduledoc """
  Migrates existing email attachments from database storage to S3 API storage.
  ...
  @shortdoc "Migrates email attachments from database to S3 API storage"
  ...
  def run(args) do
    ...
    Logger.info("Starting email attachment migration to S3 API storage")
