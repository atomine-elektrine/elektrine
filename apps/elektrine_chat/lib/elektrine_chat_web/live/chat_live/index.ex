defmodule ElektrineChatWeb.ChatLive.Index do
  ...
  alias ElektrineChatWeb.ChatLive.Bootstrap
  alias ElektrineChatWeb.ChatLive.HandleFormatter
  alias ElektrineChatWeb.ChatLive.Operations.{CallInfoOperations, Helpers, MessageInfoOperations}
  ...
  def handle_event(event_name, params, socket) do
    ...
    ElektrineChatWeb.ChatLive.Router.route_event(event_name, params, socket)
  end
