defmodule ElektrineChatWeb.Plugs.APIAuth do
  @moduledoc """
  ...
  defp get_secret_key do
    case Application.get_env(:elektrine_chat_web, ElektrineChatWeb.Endpoint)[:secret_key_base] do
      nil ->
        raise "Missing :secret_key_base for ElektrineChatWeb.Endpoint"
