defmodule ElektrineEmailWeb.EmailLive.Operations.BulkOperations do
  @moduledoc """
  ...
  import ElektrineEmailWeb.EmailLive.Operations.TabContent,
    only: [load_tab_content: 3, load_tab_content: 4, current_tab_params: 1]
