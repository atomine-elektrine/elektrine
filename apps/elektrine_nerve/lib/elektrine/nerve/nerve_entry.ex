defmodule Elektrine.Nerve.NerveEntry do
  @moduledoc """
  Schema for encrypted Nerve entries.
  """
  use Ecto.Schema
  ...
  """
  def form_changeset(nerve_entry, attrs) do
    nerve_entry
  ...
  @doc """
  Changeset for persisting encrypted nerve entries.
  """
  def create_changeset(nerve_entry, attrs) do
    nerve_entry
    |> cast(attrs, [
      :title,
      :login_username,
