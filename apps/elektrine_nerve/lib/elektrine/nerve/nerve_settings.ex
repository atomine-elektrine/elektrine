defmodule Elektrine.Nerve.NerveSettings do
  @moduledoc """
  Schema for per-user nerve setup metadata.
  ...
  @doc """
  Changeset for creating/updating nerve setup metadata.
  """
