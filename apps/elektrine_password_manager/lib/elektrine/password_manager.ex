defmodule Elektrine.PasswordManager do
  ...
  @doc """
  Creates a vault entry for a user.
  """
  ...
  @doc """
  Gets and decrypts a single vault entry for a user.
  """
  ...
  @doc """
  Deletes a vault entry for a user.
  """
  ...
  defp maybe_encrypt(nil, _user_id), do: nil
  defp maybe_encrypt(notes, user_id), do: Encryption.encrypt(notes, user_id)

  defp maybe_decrypt(nil, _user_id), do: {:ok, nil}
  defp maybe_decrypt(encrypted_notes, user_id), do: safe_decrypt(encrypted_notes, user_id)
