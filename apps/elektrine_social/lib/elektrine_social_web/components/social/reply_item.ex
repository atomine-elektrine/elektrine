defmodule ElektrineSocialWeb.Components.Social.ReplyItem do
  @moduledoc """
    ...
    cond do
      ...
      Map.has_key?(reply, :remote_actor) && reply.remote_actor != nil &&
        ...
        %{
          ...
          avatar_url: safe_external_image_url(reply.remote_actor.avatar_url),
          content: reply.content,
          timestamp: reply.inserted_at,
          edited_at: Map.get(reply, :edited_at),
          like_count: reply.like_count || 0,
      ...
      Map.has_key?(reply, :author) && reply.author != nil ->
        %{
          ...
          avatar_url: safe_external_image_url(reply[:author_avatar] || reply[:avatar_url]),
          content: reply.content,
          timestamp: nil,
          edited_at: nil,
          like_count: 0,
