defmodule ElektrineSocialWeb.TimelineLive.Post do
                ...
                <div class="flex items-center gap-2">
                  <%= if @current_user do %>
                    <button
                      ...
                      class={[
                        "btn btn-ghost btn-sm transition-all duration-150 phx-click-loading:scale-95 phx-click-loading:opacity-80",
                        Map.get(@liked_replies, @reply.id, false) &&
                          "text-red-800 phx-click-loading:text-base-content/70",
                        !Map.get(@liked_replies, @reply.id, false) &&
                          "phx-click-loading:text-red-800"
                      ]}
                    >
                      ...
                      <span class="inline-flex items-center gap-1 phx-click-loading:hidden">
                        <.icon
                          ...
                          class={["w-4 h-4", is_liked && "text-red-800"]}
                        />
                        <span>{@reply.like_count || 0}</span>
                      </span>
                      <span class="hidden items-center gap-1 phx-click-loading:inline-flex">
                        <.icon
                          name={
                            if is_liked,
                              do: "hero-heart",
                              else: "hero-heart-solid"
                          }
                          class={["w-4 h-4", !is_liked && "text-red-800"]}
                        />
                        <span>
                          {if is_liked,
                            do: max((@reply.like_count || 0) - 1, 0),
                            else: (@reply.like_count || 0) + 1}
                        </span>
                      </span>
                    </button>
                    <button
