defmodule ElektrineVPNWeb.Components.Platform.ElektrineNav do
  @moduledoc """
  VPN-owned wrapper for the shared platform navigation renderer.
  """
  ...
  attr :active_tab, :string, default: "vpn"
