defmodule ElektrineWeb.Layouts do
  ...
  @doc """
  Returns true when the current request host is an onion service.
  """
  ...
  @doc """
  Returns the onion host to display in the footer.
    ...
    |> case do
      nil ->
        case File.read("/data/tor/elektrine/hostname") do
          {:ok, host} ->
            normalize_onion_host(host) || "Not configured"
  ...
  defp normalize_onion_host(_), do: nil
end
