defmodule ElektrineWeb.API.BookmarkController do
  @moduledoc """
  API endpoint for the current user's bookmarked statuses.
  """
  ...
  def index(conn, params) do
    ...
    opts = bookmark_opts(params)

    posts = Integrations.social_saved_posts(user.id, opts)
