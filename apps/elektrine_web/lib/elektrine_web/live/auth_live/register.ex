                  ...
                  >
                    <div class="space-y-2 text-left">
                      ...
                      <p class="text-xs leading-relaxed text-base-content/70">
                        Before creating the account, your browser does a short calculation. This slows automated signups without asking you to solve a puzzle.
                      </p>
                      <p class="text-xs text-base-content/60" data-atomine-pow-status>
                        This runs when you press Create account and usually takes a few seconds.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="text-center">
                    <span class="text-error text-sm">
                      {case captcha_errors do
                        {msg, _opts} -> msg
                        [{msg, _opts} | _] -> msg
                        _ -> gettext("Please complete the security check")
                      end}
                    </span>
                  </div>
                <% end %>
