defmodule ElektrineWeb.MixProject do
  ...
  defp no_warn_undefined do
    [
      ...
      ElektrineSocialWeb.MastodonAPI.BookmarkController,
      ElektrineSocialWeb.MastodonAPI.FavouriteController,
      ElektrineSocialWeb.MastodonAPI.InstanceController,
      ElektrineSocialWeb.MastodonAPI.ListController,
      ElektrineSocialWeb.MastodonAPI.MediaController,
      ElektrineSocialWeb.MastodonAPI.MetaController,
      ElektrineSocialWeb.MastodonAPI.NotificationController,
      ElektrineSocialWeb.MastodonAPI.OAuthController,
      ElektrineSocialWeb.MastodonAPI.PollController,
      ElektrineSocialWeb.MastodonAPI.ScheduledStatusController,
      ElektrineSocialWeb.MastodonAPI.SearchController,
      ElektrineSocialWeb.MastodonAPI.StatusController,
      ElektrineSocialWeb.MastodonAPI.TimelineController,
