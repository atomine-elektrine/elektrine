  ...
  try {
    ...
    if (!data.master_configured) {
      renderState({
        ...
        summary: "Set up encrypted data on Elektrine so your account password can unlock this browser.",
    ...
    renderState({
      title: "Open Manager",
      summary: "Open the manager, then unlock Elektrine for this browser session.",
      action: "manager",
      button: "Open manager"
    })
    renderCaptureState(true)
