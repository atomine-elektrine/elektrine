defmodule ElektrineWeb.Admin.ModerationControllerTest do
  ...
  describe "POST /pripyat/content-moderation/delete" do
    test "redirects with an error for malformed content ids", %{conn: conn} do
      ...
      request_path = "/pripyat/content-moderation/delete"
      ...
      assert redirected_to(conn) == "/pripyat/content-moderation?type=timeline"
      assert Phoenix.Flash.get(conn.assigns.flash, :error) == "Timeline post not found."
    end
  end
